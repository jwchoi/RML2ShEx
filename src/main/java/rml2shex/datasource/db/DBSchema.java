...
public class DBSchema {
	...
	public String getRegexForXSDDate() {
		return Rml2Shex.dbBridge.getRegexForXSDDate();
	}

	public Optional<String> getRegexForXSDDateTime(String tableName, String columnName) {
		return Rml2Shex.dbBridge.getRegexForXSDDateTime(catalog, tableName, columnName);
	}

	public Optional<String> getRegexForXSDDecimal(String tableName, String columnName) {
		return Rml2Shex.dbBridge.getRegexForXSDDecimal(catalog, tableName, columnName);
	}

	public Optional<String> getRegexForXSDTime(String tableName, String columnName) {
		return Rml2Shex.dbBridge.getRegexForXSDTime(catalog, tableName, columnName);
	}
	...
	public Optional<String> getMaximumDateValue() {
		return Rml2Shex.dbBridge.getMaximumDateValue();
	}

	public Optional<String> getMinimumDateValue() {
		return Rml2Shex.dbBridge.getMinimumDateValue();
	}
