...
public class MariaDBResultSet extends SQLResultSet {
    private Optional<ZoneOffset> dbZoneOffset;
    private List<Integer> timeZoneAwareTemporalDataTypeColumnIndexes;

    MariaDBResultSet(ResultSet rs, ResultSetMetaData rsmd, Optional<ZoneOffset> dbZoneOffset, List<Integer> timeZoneAwareTemporalDataTypeColumnIndexes) {
        super(rs, rsmd);
