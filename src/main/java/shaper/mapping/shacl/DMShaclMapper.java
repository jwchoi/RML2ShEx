...
public class DMShaclMapper extends ShaclMapper {
    ...
    public File generateShaclFile() {
        DMModel dmModel = DMModelFactory.generateMappingModel(Shaper.dbSchema);
        shaclDocModel = ShaclDocModelFactory.getSHACLDocModel(dmModel);
